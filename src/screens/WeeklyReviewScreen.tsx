...
export function WeeklyReviewScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable style={styles.button} onPress={loadReport}><Text style={styles.buttonText}>Run Weekly Report</Text></Pressable>
      ...
      {!!report && (
        <View style={styles.card}>
          ...
          <Text style={styles.block}>Actions: {report.recommended_actions.join(', ')}</Text>
        </View>
      )}
    </View>
  );
